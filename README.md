...
| **PUT ***`/section`***** | id, content, content_type, image_url, font_size, font_weight, font_family, line_height, margin_top, text_align, text_color, **token** | Change section |
| **POST ***`/section`***** | article_id, content, content_type, image_url, font_size, font_weight, font_family, line_height, margin_top, text_align, text_color, **token** | Add new section |
